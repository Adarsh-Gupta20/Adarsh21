...
label1 = Label(root, text = "Password Generator App", font = "time 15 bold")
label1.place(x = 30, y = 30)

label2 = Label(root, text = "Enter Password Length : ", font = "time 15 bold")
label2.place(x = 30, y = 90)

e1 = Entry(root, width = 46, bd = 2, font = "time 13 bold")
e1.place(x = 30, y = 133)

button = Button(root, text = "Generate Password", fg = "white", bg = "red",
                font = "time 15 bold", width = 34, command = gen)
